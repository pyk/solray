...
| STT-09 | `inspect function-source` code blocks for the requested function MUST be valid Solidity source                                                                   |
| STT-10 | `inspect function-source` code blocks for the requested function MUST match the original source after intended dedent and NatSpec resolution                     |
